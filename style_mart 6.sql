...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2025 at 02:05 PM
...
(67, 10, 'M', 0, '2025-06-18 18:07:49', '2025-06-22 19:52:54'),
...
INSERT INTO `transaction` (`transaction_id`, `buyer_id`, `seller_id`, `payment_status`, `total_amount`, `receipt`, `confirmed_by`, `transaction_date`, `status`, `product_id`) VALUES
(71, 18, 11, 'Paid', 12.00, 'uploads/receipts/1750593144_Screenshot (1).png', NULL, '2025-06-22 19:52:24', 'pending', 10),
(72, 18, 11, 'Paid', 12.00, 'uploads/receipts/1750593174_Screenshot (1).png', NULL, '2025-06-22 19:52:54', 'pending', 10);
...
(18, 'ngwenghin', '', '$2y$10$eyqRr7uF11aDxjOUyryofOeiNqaZHSIlKdsgeJpQGKL6.BLgVF2oS', NULL, '1111', 'uploads/6857ef0fa2765_Screenshot (2).png');
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `transaction`
  MODIFY `transaction_id` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
